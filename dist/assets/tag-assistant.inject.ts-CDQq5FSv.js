const m="amd-ta-root",d="amd-ta-pinned",u="amd-ta-var-root",v="amd-ta-hidden",B="amd-ta-var-hidden",l="amd-ta-pin-btn",h="amd-ta-pin-on",k="amd-ta-hl",b=new Map;let E="",g="";const T=[".message-list",'[class*="message-list"]',".messages-panel"],y=[".message-list__row--indented",'[class*="message-list__row"][class*="indented"]','[class*="message-list__row--indented"]'],Y=[".message-list__row:not(.message-list__row--indented)",'[class*="message-list__row"]:not([class*="indented"])'],R='variables-tab:not([aria-hidden="true"]):not(.ng-hide)',q=".gtm-debug-variable-table-row",P=".gtm-debug-chip",M=".gtm-debug-variable-table-value",G=".gtm-debug-variable-pane-content";function L(t,n=document){for(const e of t){const a=n.querySelector(e);if(a)return a}return null}function H(t,n=document){for(const e of t){const a=Array.from(n.querySelectorAll(e));if(a.length)return a}return[]}function U(){const t=[],n=(e,a)=>{for(const i of a){const o=document.querySelectorAll(i).length;o&&t.push(`${e}: "${i}" (${o})`)}};n("event list",T),n("event row",y),[R,q,P,M].forEach(e=>{const a=document.querySelectorAll(e).length;a&&t.push(`var: "${e}" (${a})`)}),t.length&&(console.groupCollapsed("[LayerLens] Tag Assistant selector discovery"),t.forEach(e=>console.log(e)),console.groupEnd())}function N(t){var n,e;return((e=(n=t.querySelector(".message-list__title span[title]"))==null?void 0:n.getAttribute("title"))==null?void 0:e.trim())??""}function _(t){var n,e;return((e=(n=t.querySelector('.message-list__index, [class*="message-list__index"]'))==null?void 0:n.textContent)==null?void 0:e.trim())??""}function W(){var n;const t=L(T);return t||(((n=L(y))==null?void 0:n.parentElement)??null)}function D(t){let n=t.parentElement;for(;n&&n!==document.body;){const{overflowY:e}=getComputedStyle(n);if(e==="auto"||e==="scroll")return n;n=n.parentElement}return t.parentElement??document.body}function w(){return H(y)}function K(t){var o,s,c;const n=((o=document.getElementById(m))==null?void 0:o.parentElement)??D(t),e=(((s=document.getElementById(m))==null?void 0:s.offsetHeight)??46)+(((c=document.getElementById(d))==null?void 0:c.offsetHeight)??0)+10,a=t.getBoundingClientRect().top,i=n.getBoundingClientRect().top;n.scrollTo({top:n.scrollTop+(a-i)-e,behavior:"smooth"})}function O(){return'<svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M15 4.5l-4 4l-4 1.5l-1.5 1.5l7 7l1.5 -1.5l1.5 -4l4 -4"/><path d="M9 15l-4.5 4.5"/><path d="M14.5 4l5.5 5.5"/></svg>'}function V(t=14){return`<svg viewBox="0 0 24 24" width="${t}" height="${t}" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><path d="M21 21l-4.35-4.35"/></svg>`}function J(){if(document.getElementById("amd-ta-style"))return;const t=document.createElement("style");t.id="amd-ta-style",t.textContent=`
  ...
  `,document.head.appendChild(t)}function Q(){var a,i,o;if((a=document.getElementById(m))!=null&&a.isConnected)return;(i=document.getElementById(m))==null||i.remove();const t=W();if(!t)return;const n=D(t),e=document.createElement("div");e.id=m,e.innerHTML=`
    ...
    </div>`,n.prepend(e),(o=document.getElementById("amd-ta-search-input"))==null||o.addEventListener("input",s=>{E=s.target.value.toLowerCase().trim(),F(w())})}function S(){var e,a,i;if(b.size===0){(e=document.getElementById(d))==null||e.remove();return}if(!((a=document.getElementById(d))!=null&&a.isConnected)){(i=document.getElementById(d))==null||i.remove();const o=document.getElementById(m);if(!(o!=null&&o.isConnected))return;const s=document.createElement("div");s.id=d,o.insertAdjacentElement("afterend",s)}const t=document.getElementById(d);t.innerHTML=`<div class="amd-ta-pin-sep">Fissati&nbsp;<span style="font-weight:400;opacity:.7">(${b.size})</span></div>`;const n=w();for(const[o,s]of b){const c=n.find(r=>_(r)===o);if(c){const r=c.cloneNode(!0);r.classList.add("amd-ta-clone"),r.removeAttribute("data-amd-pin-added"),r.querySelectorAll(`.${l}`).forEach(f=>f.remove()),X(r,o),r.addEventListener("click",f=>{if(f.target.closest(`.${l}`))return;f.preventDefault(),f.stopPropagation();const p=w().filter(x=>!x.closest(`#${d}`)).find(x=>_(x)===o);p&&(K(p),p.style.transition="background .1s",p.style.background="rgba(229,198,20,.45)",setTimeout(()=>{p.style.background="",p.style.transition=""},900))}),t.appendChild(r)}else{const r=document.createElement("div");r.className="amd-ta-placeholder",r.textContent=`${s} — non in questa pagina`,t.appendChild(r)}}}function X(t,n){const e=document.createElement("button");e.type="button",e.className=`${l} ${h}`,e.title="Rimuovi dai fissati",e.setAttribute("aria-pressed","true"),e.innerHTML=O(),e.addEventListener("click",a=>{a.stopPropagation(),a.preventDefault(),z(n)}),t.appendChild(e)}function z(t){b.delete(t),w().filter(n=>_(n)===t).forEach(n=>{n.classList.remove(k);const e=n.querySelector(`.${l}`);e&&(e.classList.remove(h),e.title="Fissa in cima",e.setAttribute("aria-pressed","false"))}),S()}function F(t){let n=0;for(const i of t){const o=!E||N(i).toLowerCase().includes(E);i.classList.toggle(v,!o),o&&n++}const e=H(Y);for(const i of e){if(!E){i.classList.remove(v);continue}let o=i.nextElementSibling,s=!1;for(;o&&o.matches(y[0]);){if(!o.classList.contains(v)){s=!0;break}o=o.nextElementSibling}i.classList.toggle(v,!s)}const a=document.getElementById("amd-ta-count");a&&(E?(a.textContent=`${n} / ${t.length}`,a.style.display=""):a.style.display="none")}function Z(t){for(const n of t){if(n.dataset.amdPinAdded)continue;n.dataset.amdPinAdded="1";const e=_(n),a=N(n),i=b.has(e);i&&n.classList.add(k);const o=document.createElement("button");o.type="button",o.className=`${l}${i?` ${h}`:""}`,o.title=i?"Rimuovi dai fissati":"Fissa in cima",o.setAttribute("aria-pressed",String(i)),o.innerHTML=O(),o.addEventListener("click",s=>{if(s.stopPropagation(),s.preventDefault(),!b.has(e))b.set(e,a),n.classList.add(k),o.classList.add(h),o.title="Rimuovi dai fissati",o.setAttribute("aria-pressed","true");else{z(e);return}S()}),n.appendChild(o)}}function A(){return document.querySelector(R)}function ee(){var i,o,s;const t=A();if(!t){(i=document.getElementById(u))==null||i.remove();return}if((o=document.getElementById(u))!=null&&o.isConnected){$(t);return}(s=document.getElementById(u))==null||s.remove();const n=t.querySelector(G);if(!n)return;const e=document.createElement("div");e.id=u,e.innerHTML=`
    <div class="amd-ta-brand">
    ...
    </div>`,n.prepend(e);const a=e.querySelector("#amd-ta-var-input");g&&(a.value=g),a.addEventListener("input",c=>{g=c.target.value.toLowerCase().trim();const r=A();r&&$(r)}),$(t)}function $(t){var i,o,s,c;const n=Array.from(t.querySelectorAll(q));let e=0;for(const r of n){const f=((o=(i=r.querySelector(P))==null?void 0:i.textContent)==null?void 0:o.toLowerCase())??"",p=((c=(s=r.querySelector(M))==null?void 0:s.textContent)==null?void 0:c.toLowerCase())??"",x=!g||f.includes(g)||p.includes(g);r.classList.toggle(B,!x),x&&e++}const a=document.getElementById("amd-ta-var-count");a&&(g&&n.length>0?(a.textContent=`${e} / ${n.length}`,a.style.display=""):a.style.display="none")}function j(){if(J(),L(y)){Q();const t=w();Z(t),F(t),requestAnimationFrame(S)}ee()}let C=!1,I=!1;const te=new MutationObserver(t=>{t.every(e=>{var i;const a=e.target;return!!((i=a.closest)!=null&&i.call(a,`#${m}, #${d}, #${u}, #amd-ta-style`))})||C||(C=!0,requestAnimationFrame(()=>{C=!1,!I&&L(y)&&(I=!0,U()),j()}))});te.observe(document.body,{childList:!0,subtree:!0});j();
