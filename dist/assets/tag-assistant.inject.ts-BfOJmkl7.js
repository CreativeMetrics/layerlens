const m="amd-ta-root",d="amd-ta-pinned",p="amd-ta-var-root",y="amd-ta-hidden",T="amd-ta-var-hidden",c="amd-ta-pin-btn",E="amd-ta-pin-on",k="amd-ta-hl",g=new Map;let v="",f="";const B=[".message-list",'[class*="message-list"]',".messages-panel"],h=[".message-list__row--indented",'[class*="message-list__row"][class*="indented"]','[class*="message-list__row--indented"]'],j=[".message-list__row:not(.message-list__row--indented)",'[class*="message-list__row"]:not([class*="indented"])'],R='variables-tab:not([aria-hidden="true"]):not(.ng-hide)',q=".gtm-debug-variable-table-row",P=".gtm-debug-chip",M=".gtm-debug-variable-table-value",Y=".gtm-debug-variable-pane-content";function _(t,n=document){for(const e of t){const a=n.querySelector(e);if(a)return a}return null}function H(t,n=document){for(const e of t){const a=Array.from(n.querySelectorAll(e));if(a.length)return a}return[]}function G(){const t=[],n=(e,a)=>{for(const i of a){const o=document.querySelectorAll(i).length;o&&t.push(`${e}: "${i}" (${o})`)}};n("event list",B),n("event row",h),[R,q,P,M].forEach(e=>{const a=document.querySelectorAll(e).length;a&&t.push(`var: "${e}" (${a})`)}),t.length&&(console.groupCollapsed("[LayerLens] Tag Assistant selector discovery"),t.forEach(e=>console.log(e)),console.groupEnd())}function N(t){var n,e;return((e=(n=t.querySelector(".message-list__title span[title]"))==null?void 0:n.getAttribute("title"))==null?void 0:e.trim())??""}function L(t){var n,e;return((e=(n=t.querySelector('.message-list__index, [class*="message-list__index"]'))==null?void 0:n.textContent)==null?void 0:e.trim())??""}function U(){var n;const t=_(B);return t||(((n=_(h))==null?void 0:n.parentElement)??null)}function W(t){let n=t.parentElement;for(;n&&n!==document.body;){const{overflowY:e}=getComputedStyle(n);if(e==="auto"||e==="scroll")return n;n=n.parentElement}return t.parentElement??document.body}function w(){return H(h)}function K(t){var o,s,l;const n=(o=document.getElementById(m))==null?void 0:o.parentElement;if(!n){t.scrollIntoView({block:"center"});return}const e=(((s=document.getElementById(m))==null?void 0:s.offsetHeight)??46)+(((l=document.getElementById(d))==null?void 0:l.offsetHeight)??0)+10;let a=0,i=t;for(;i&&i!==n;)a+=i.offsetTop,i=i.offsetParent;n.scrollTo({top:Math.max(0,a-e)})}function V(){return'<svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M15 4.5l-4 4l-4 1.5l-1.5 1.5l7 7l1.5 -1.5l1.5 -4l4 -4"/><path d="M9 15l-4.5 4.5"/><path d="M14.5 4l5.5 5.5"/></svg>'}function z(t=14){return`<svg viewBox="0 0 24 24" width="${t}" height="${t}" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><path d="M21 21l-4.35-4.35"/></svg>`}function J(){if(document.getElementById("amd-ta-style"))return;const t=document.createElement("style");t.id="amd-ta-style",t.textContent=`
  ...
  `,document.head.appendChild(t)}function Q(){var a,i,o;if((a=document.getElementById(m))!=null&&a.isConnected)return;(i=document.getElementById(m))==null||i.remove();const t=U();if(!t)return;const n=W(t),e=document.createElement("div");e.id=m,e.innerHTML=`
    ...
    </div>`,n.prepend(e),(o=document.getElementById("amd-ta-search-input"))==null||o.addEventListener("input",s=>{v=s.target.value.toLowerCase().trim(),O(w())})}function C(){var e,a,i;if(g.size===0){(e=document.getElementById(d))==null||e.remove();return}if(!((a=document.getElementById(d))!=null&&a.isConnected)){(i=document.getElementById(d))==null||i.remove();const o=document.getElementById(m);if(!(o!=null&&o.isConnected))return;const s=document.createElement("div");s.id=d,o.insertAdjacentElement("afterend",s)}const t=document.getElementById(d);t.innerHTML=`<div class="amd-ta-pin-sep">Fissati&nbsp;<span style="font-weight:400;opacity:.7">(${g.size})</span></div>`;const n=w();for(const[o,s]of g){const l=n.find(r=>L(r)===o);if(l){const r=l.cloneNode(!0);r.classList.add("amd-ta-clone"),r.removeAttribute("data-amd-pin-added"),r.querySelectorAll(`.${c}`).forEach(u=>u.remove()),X(r,o),r.addEventListener("click",u=>{if(u.target.closest(`.${c}`))return;u.preventDefault(),u.stopPropagation();const b=w().filter(x=>!x.closest(`#${d}`)).find(x=>L(x)===o);b&&(K(b),b.classList.add("amd-ta-flash"),setTimeout(()=>b.classList.remove("amd-ta-flash"),1100))}),t.appendChild(r)}else{const r=document.createElement("div");r.className="amd-ta-placeholder",r.textContent=`${s} — non in questa pagina`,t.appendChild(r)}}}function X(t,n){const e=document.createElement("button");e.type="button",e.className=`${c} ${E}`,e.title="Rimuovi dai fissati",e.setAttribute("aria-pressed","true"),e.innerHTML=V(),e.addEventListener("click",a=>{a.stopPropagation(),a.preventDefault(),D(n)}),t.appendChild(e)}function D(t){g.delete(t),w().filter(n=>L(n)===t).forEach(n=>{n.classList.remove(k);const e=n.querySelector(`.${c}`);e&&(e.classList.remove(E),e.title="Fissa in cima",e.setAttribute("aria-pressed","false"))}),C()}function O(t){let n=0;for(const i of t){const o=!v||N(i).toLowerCase().includes(v);i.classList.toggle(y,!o),o&&n++}const e=H(j);for(const i of e){if(!v){i.classList.remove(y);continue}let o=i.nextElementSibling,s=!1;for(;o&&o.matches(h[0]);){if(!o.classList.contains(y)){s=!0;break}o=o.nextElementSibling}i.classList.toggle(y,!s)}const a=document.getElementById("amd-ta-count");a&&(v?(a.textContent=`${n} / ${t.length}`,a.style.display=""):a.style.display="none")}function Z(t){for(const n of t){if(n.dataset.amdPinAdded)continue;n.dataset.amdPinAdded="1";const e=L(n),a=N(n),i=g.has(e);i&&n.classList.add(k);const o=document.createElement("button");o.type="button",o.className=`${c}${i?` ${E}`:""}`,o.title=i?"Rimuovi dai fissati":"Fissa in cima",o.setAttribute("aria-pressed",String(i)),o.innerHTML=V(),o.addEventListener("click",s=>{if(s.stopPropagation(),s.preventDefault(),!g.has(e))g.set(e,a),n.classList.add(k),o.classList.add(E),o.title="Rimuovi dai fissati",o.setAttribute("aria-pressed","true");else{D(e);return}C()}),n.appendChild(o)}}function A(){return document.querySelector(R)}function ee(){var i,o,s;const t=A();if(!t){(i=document.getElementById(p))==null||i.remove();return}if((o=document.getElementById(p))!=null&&o.isConnected){$(t);return}(s=document.getElementById(p))==null||s.remove();const n=t.querySelector(Y);if(!n)return;const e=document.createElement("div");e.id=p,e.innerHTML=`
    <div class="amd-ta-brand">
    ...
    </div>`,n.prepend(e);const a=e.querySelector("#amd-ta-var-input");f&&(a.value=f),a.addEventListener("input",l=>{f=l.target.value.toLowerCase().trim();const r=A();r&&$(r)}),$(t)}function $(t){var i,o,s,l;const n=Array.from(t.querySelectorAll(q));let e=0;for(const r of n){const u=((o=(i=r.querySelector(P))==null?void 0:i.textContent)==null?void 0:o.toLowerCase())??"",b=((l=(s=r.querySelector(M))==null?void 0:s.textContent)==null?void 0:l.toLowerCase())??"",x=!f||u.includes(f)||b.includes(f);r.classList.toggle(T,!x),x&&e++}const a=document.getElementById("amd-ta-var-count");a&&(f&&n.length>0?(a.textContent=`${e} / ${n.length}`,a.style.display=""):a.style.display="none")}function F(){if(J(),_(h)){Q();const t=w();Z(t),O(t),requestAnimationFrame(C)}ee()}let S=!1,I=!1;const te=new MutationObserver(t=>{t.every(e=>{var i;const a=e.target;return!!((i=a.closest)!=null&&i.call(a,`#${m}, #${d}, #${p}, #amd-ta-style`))})||S||(S=!0,requestAnimationFrame(()=>{S=!1,!I&&_(h)&&(I=!0,G()),F()}))});te.observe(document.body,{childList:!0,subtree:!0});F();
